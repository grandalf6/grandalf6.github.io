...
class SelfDescription extends React.Component {
  ...
  componentDidMount() {
    ...
    new TypeIt(current, {
      strings:
        'I am front end web developer with React living in London. My adventure with web development started about 2 years ago as a hobby and most of skills I gained through project-based learning and by just being curious. Recently, I gained some certificates to structure my knowledge and confirm competence and enhance myself on the market.',
      speed: 7,
      startDelay: 100,
